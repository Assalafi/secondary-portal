...
class LocationController extends Controller
{
    ...
    {
        return response()->json(array_keys($this->statesAndLgas));
    }
    ...
    public function getLgas(Request $request): JsonResponse
    {
        ...
        if ($state && isset($this->statesAndLgas[$state])) {
            return response()->json($this->statesAndLgas[$state]);
        }
