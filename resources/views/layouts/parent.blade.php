...
<head>
    ...
    @if($schoolSettings)
        ...
        @if($schoolSettings->school_name)
            ...
            <title>@yield('title', $schoolSettings->school_name) - Parent Portal</title>
        @else
            <title>@yield('title', 'School Management System') - Parent Portal</title>
        @endif
    @else
        <link rel="icon" type="image/x-icon" href="{{ asset('favicon.ico') }}">
        <title>@yield('title', 'School Management System') - Parent Portal</title>
    ...
    <!-- Title -->
    <title>@yield('title', $globalSettings['school_name']) - Parent Portal</title>
</head>
...
<body class="boxed-size bg-white">
    ...
    <div class="sidebar-area border-end" id="sidebar-area">
        <div class="logo position-relative">
            <a href="{{ route('parent.dashboard') }}" class="d-block text-decoration-none position-relative d-flex justify-content-center">
            ...
            <ul class="menu-inner">
                <li class="menu-item">
                    <a href="{{ route('parent.dashboard') }}"
                        class="menu-link {{ request()->routeIs('parent.dashboard') ? 'active' : '' }}">
                ...
                <li class="menu-item">
                    <a href="{{ route('parent.dependents.index') }}"
                        class="menu-link {{ request()->routeIs('parent.dependents.*') ? 'active' : '' }}">
                        <span class="material-symbols-outlined menu-icon">group</span>
                        <span class="title">My Dependents</span>
                    </a>
                </li>

                <li class="menu-item">
                    <a href="{{ route('parent.admission.index') }}"
                        class="menu-link {{ request()->routeIs('parent.admission.*') ? 'active' : '' }}">
                ...
                <li class="menu-item">
                    <a href="{{ route('parent.payments.index') }}"
                        class="menu-link {{ request()->routeIs('parent.payments.*') ? 'active' : '' }}">
                ...
                <li class="menu-item">
                    <a href="{{ route('parent.support.index') }}"
                        class="menu-link {{ request()->routeIs('parent.support.*') ? 'active' : '' }}">
                                    ...
                                    <div class="dropdown notifications apps">
                                        ...
                                        <div class="dropdown-menu dropdown-lg p-0 border-0 py-4 px-3 max-h-312" data-simplebar>
                                            <div class="notification-menu d-flex flex-wrap justify-content-between gap-4">
                                                <a href="{{ route('parent.dependents.index') }}" class="dropdown-item p-0 text-center">
                                                    <i class="material-symbols-outlined wh-25 text-primary">group</i>
                                                    <span>Dependents</span>
                                                </a>
                                                <a href="{{ route('parent.payments.index') }}" class="dropdown-item p-0 text-center">
                                                    <i class="material-symbols-outlined wh-25 text-success">payments</i>
                                                    <span>Payment</span>
                                                </a>
                                                <a href="{{ route('parent.support.index') }}" class="dropdown-item p-0 text-center">
                                                    <i class="material-symbols-outlined wh-25 text-warning">support_agent</i>
                                                    <span>Support</span>
                                                </a>
                                                <a href="{{ route('parent.account.index') }}" class="dropdown-item p-0 text-center">
                                ...
                                <li class="header-right-item">
                                    <div class="dropdown admin-profile">
                                        <div class="d-xxl-flex align-items-center bg-transparent border-0 text-start p-0 cursor dropdown-toggle" data-bs-toggle="dropdown">
                                            <div class="flex-shrink-0">
                                                <img class="rounded-circle wh-40 administrator" src="{{ asset('assets/images/administrator.jpg') }}" alt="parent">
                                            </div>
                                        ...
                                        <div class="dropdown-menu border-0 bg-white dropdown-menu-end">
                                            <div class="d-flex align-items-center info">
                                                <div class="flex-shrink-0">
                                                    <img class="rounded-circle wh-30 administrator" src="{{ asset('assets/images/administrator.jpg') }}" alt="parent">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <h3 class="fw-medium">{{ Auth::user()->name }}</h3>
                                                    <span class="fs-12">Parent/Guardian</span>
                                                </div>
                                            </div>
                                            <ul class="admin-link ps-0 mb-0 list-unstyled">
                                                <li>
                                                    <a class="dropdown-item admin-item-link d-flex align-items-center text-body" href="{{ route('parent.account.index') }}">
                                                        <i class="material-symbols-outlined">account_circle</i>
                                                        <span class="ms-2">My Profile</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item admin-item-link d-flex align-items-center text-body" href="{{ route('parent.dependents.index') }}">
                                                        <i class="material-symbols-outlined">group</i>
                                                        <span class="ms-2">My Dependents</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item admin-item-link d-flex align-items-center text-body" href="{{ route('parent.payments.index') }}">
                                            ...
                                            <ul class="admin-link ps-0 mb-0 list-unstyled">
                                                <li>
                                                    <a class="dropdown-item admin-item-link d-flex align-items-center text-body" href="{{ route('parent.support.index') }}">
