            ...
            <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('parent.dashboard') }}" class="text-muted text-decoration-none">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="{{ route('parent.payments.index') }}" class="text-muted text-decoration-none">Payments</a>
                            </li>
                            <li class="breadcrumb-item active text-muted" aria-current="page">Details</li>
                        </ol>
                    </nav>
                </div>
                <div class="d-flex gap-2">
                    ...
                    @if($invoice->status === 'Paid')
                        <a href="{{ route('parent.payments.download-receipt', $invoice->id) }}" class="btn btn-primary" target="_blank">
