    ...
    <div class="container">
                    ...
                    <td>
                        <div class="info-box">
                            <table>
                                ...
                                <tr>
                                    <td>ID:</td>
                                    <td>STU-{{ str_pad($invoice->student->id, 5, '0', STR_PAD_LEFT) }}</td>
                                </tr>
                                <tr>
                                    <td>Class:</td>
                                    <td>{{ $invoice->student->classArm ? $invoice->student->classArm->schoolClass->name . ' ' . $invoice->student->classArm->name : 'N/A' }}</td>
                                </tr>
                            </table>
                        </div>
                    </td>
        ...
        <table class="payment-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $item->feeSetup->payment_type ?? 'School Fees' }}</td>
