...
class ProductionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $subjectData = [
            ...
            ['name' => 'Chemistry', 'code' => 'CHM', 'type' => 'Science'],
            ['name' => 'Physics', 'code' => 'PHY', 'type' => 'Science'],
            ['name' => 'Further Mathematics', 'code' => 'FMT', 'type' => 'Science'],
            ['name' => 'Agricultural Science', 'code' => 'AGR', 'type' => 'Science'],
            ['name' => 'Economics', 'code' => 'ECO', 'type' => 'Commercial'],
            ['name' => 'Commerce', 'code' => 'COM', 'type' => 'Commercial'],
            ['name' => 'Accounting', 'code' => 'ACC', 'type' => 'Commercial'],
            ['name' => 'Government', 'code' => 'GOV', 'type' => 'Arts'],
            ['name' => 'Literature in English', 'code' => 'LIT', 'type' => 'Arts'],
            ['name' => 'Christian Religious Studies', 'code' => 'CRS', 'type' => 'Arts'],
            ['name' => 'Islamic Religious Studies', 'code' => 'IRS', 'type' => 'Arts'],
            ['name' => 'History', 'code' => 'HIS', 'type' => 'Arts'],
            ...
            ['name' => 'Technical Drawing', 'code' => 'TDR', 'type' => 'Science'],
            ['name' => 'French', 'code' => 'FRN', 'type' => 'Arts'],
        ];
